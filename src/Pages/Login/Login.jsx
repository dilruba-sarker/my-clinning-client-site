    ...
    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
      <div className="card-body">
        <form onSubmit={handleSubmit} className="form">
          ...
          <div className='w-full flex justify-center'> <button className="btn bg-blue-600 text-white text-Black w-4/5 mt-4">Login</button></div>
          <p className='text-blue-600 font-bold'>Don't have Account Signup First
          <Link to="/register"> <button className="text-white  btn bg-blue-600">Register</button></Link></p>
